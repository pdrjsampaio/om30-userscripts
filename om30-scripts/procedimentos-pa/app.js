(() => {
  ...
  if (window.__OM30_PA_REMOTE__) {
    try { document.getElementById('om30pa')?.remove(); } catch {}
    try { document.querySelector('.om30-cs-wrap')?.remove(); } catch {}
  }
  window.__OM30_PA_REMOTE__ = '0.4.1';
